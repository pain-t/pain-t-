...
public class ShapesController extends Controller {
	...
	/**
	 * Enumeration of possible corner handlers. TP: Top Left, TR: Top Right, BL:
	 * Bottom Left, BR: Bottom Right, NULL: None.
	 */
	...
	/**
	 * Constructs a ShapesController with an empty last cursor location, and an
	 * empty list of selected shapes (for the copy and paste action).
	 * 
	 * @param model
	 *            Exhausitive list of all the existing shapes.
	 */
	...
	public void keyPressed(KeyEvent evt) {
		...
		// Navigation among the shapes
			...
			BufferedImage screenshotImage = new BufferedImage(this.getView().getBounds().width,
					this.getView().getBounds().height, BufferedImage.TYPE_INT_RGB);
			this.getView().paint(screenshotImage.getGraphics());
	 ...
	 * 
	 * @param s
	 *            Shape from which you want the selection attribute.
	...
	/**
	 * If a shape is selected, returns it, else returns null. If a shape is selected
	 * by one of its corner, indicates it in <em>handler</em>.
	 * 
	 * @param p
	...
	/**
	 * Translates all selected shapes from the model collection by an x and an y
	 * offset.
	 * 
	 * @param dx
	 *            x offset.
	...
	/**
	 * Resizes all selected shapes from the model collection by an x and an y
	 * offset, by a specified corner handler.
	 * 
	 * @param dx
	 *            x offset.
	 * @param dy
	 *            y offset.
	 * @param handler
	 *            Corner handler by which the selected forms are resized.
	 */
	 ...
	 * 
	 * @param s
	 *            Shape to put one step closer in the foreground.
	 */
	private void closer(Shape s) {
		if (s != null)
			this.getModel().getData().closer(s);
	}
	 ...
	 * 
	 * @param s
	 *            Shape to put one step farther in the background.
	 */
	private void farther(Shape s) {
		if (s != null)
			this.getModel().getData().farther(s);
	}
	...
	/**
	 * Creates a lasso selector, whose upper-left corner is specified as a (x, y)
	 * coordinates and whose width and height are specified by the arguments of the
	 * same name.
	 * 
	 * @param x
	 ...
	 * @param width
	 *            The width of the lasso.
	 * @param height
	 *            The height of the lasso.
	 */
